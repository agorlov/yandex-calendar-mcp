...
Тест полезен для проверки функции создания событий без их последующего удаления.
Отличается от общего теста (test.py) тем, что фокусируется только на создании.
"""
